                    ...
                    case "luu":
                        {
                            ...
                            try
                            {
                                ...
                                dt.Load(SqlHelper.ExecuteReader(Commons.IConnections.CNStr, "spUpdateKINH_NGHIEM_LV", (AddEdit ? -1 : Id), txtMS_KNLV.EditValue.ToString(), txtKNLV.EditValue.ToString(), txtKNLV_A.EditValue.ToString(), txtKNLV_H.EditValue.ToString(), txtGHI_CHU.EditValue.ToString()));
