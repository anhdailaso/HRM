...
namespace Vs.Category
{
    public partial class frmEditLOAI_KHEN_THUONG : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void LoadText()
        {
            try
            {
                string sSql = "SELECT ID_LOAI_KT, TEN_LOAI_KT, TEN_LOAI_KT_A, TEN_LOAI_KT_H " +
                    ...
                    case "luu":
                        {
                            ...
                            Commons.Modules.sId = SqlHelper.ExecuteScalar(Commons.IConnections.CNStr, "spUpdateLOAI_KHEN_THUONG", (AddEdit ? -1 : Id),
                                TEN_LOAI_KTTextEdit.EditValue, TEN_LOAI_KT_ATextEdit.EditValue, TEN_LOAI_KT_HTextEdit.EditValue).ToString();
                            if (AddEdit)
                            {
