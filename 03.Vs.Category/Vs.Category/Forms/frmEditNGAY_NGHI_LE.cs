...
namespace Vs.Category
{
    public partial class frmEditNGAY_NGHI_LE : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void LoadText()
        {
            try
            {
                string sSql = "SELECT ID_NNL,NGAY, LY_DO " +
                    ...
                    case "luu":
                        {
                            ...
                            try
                            {
                                ...
                                dt.Load(SqlHelper.ExecuteReader(Commons.IConnections.CNStr, "spUpdateNGAY_NGHI_LE", (AddEdit ? 1 : 0), NGAYDateEdit.EditValue, LY_DOTextEdit.EditValue.ToString()));
