...
namespace Vs.Report
{
    ...
    {
        public rptBCPhieuTienPhep(DateTime ngayin, DateTime TuNgay, DateTime DenNgay)
        {

            InitializeComponent();
            Commons.Modules.ObjSystems.ThayDoiNN(this);

            //NONlbNGAY.Text = "Từ ngày " + TuNgay.ToString("dd/MM/yyyy") + " đến ngày " + DenNgay.ToString("dd/MM/yyyy");
