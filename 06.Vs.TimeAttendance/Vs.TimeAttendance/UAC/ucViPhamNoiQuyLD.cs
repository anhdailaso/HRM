    ...
    public partial class ucViPhamNoiQuyLD : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        private void LoadGrdVPNoiQuy()
        {
            ...
            try
            {
                ...
                //cboNQLD.Columns.Add(new DevExpress.XtraEditors.Controls.LookUpColumnInfo("ID_NQLD"));
                //cboNQLD.Columns["ID_NQLD"].Visible = false;
                ...
                //cboNQLD.ShowDropDown = DevExpress.XtraEditors.Controls.ShowDropDown.SingleClick;
            }
            catch(Exception EX)
            {
        ...
        private void XoaKeHoachDiCa()
        {
            ...
            try
            {
                string sSql = "DELETE dbo.KE_HOACH_DI_CA WHERE ID_CN = " + grvViPhamNoiQuyLD.GetFocusedRowCellValue("ID_CN") + "  AND TU_NGAY = '" + Convert.ToDateTime(grvViPhamNoiQuyLD.GetFocusedRowCellValue("TU_NGAY")).ToString("MM/dd/yyyy") + "' ";
        ...
        private void grvCongNhan_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
      {
        ...
        private void grvKeHoachDiCa_ValidateRow(object sender, DevExpress.XtraGrid.Views.Base.ValidateRowEventArgs e)
        {
            ...
            Commons.Modules.ObjSystems.MCreateTableToDatatable(Commons.IConnections.CNStr, btKHDC, Commons.Modules.ObjSystems.ConvertDatatable(grvViPhamNoiQuyLD), "");

            try
            {
                int n = Convert.ToInt32(SqlHelper.ExecuteScalar(Commons.IConnections.CNStr, "spKiemTraKHDiCa", btKHDC, grvViPhamNoiQuyLD.GetFocusedRowCellValue("ID_CN"), grvViPhamNoiQuyLD.GetFocusedRowCellValue("TU_NGAY"), grvViPhamNoiQuyLD.GetFocusedRowCellValue("DEN_NGAY")));
                if (n > 1)
                {
                    e.Valid = false;
