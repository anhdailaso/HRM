...
namespace Vs.TimeAttendance
{
    public partial class ucBaoCaoTongHopThang : DevExpress.XtraEditors.XtraUserControl
    {
                            ...
                            case 0:
                                {
                                    ...
                                    try
                                    {
                                        ...
                                        string strSQL = "SELECT KY_HIEU FROM dbo.DON_VI WHERE ID_DV = " + Convert.ToInt64(LK_DON_VI.EditValue) + "";
                            ...
                            case 1:
                                {
                                    ...
                                    switch (KyHieuDV)
                                    {
                                        ...
                                        default:
                                            BangChamCongTangCaThangDefault();
                                            break;
                                    }
                                }
                                break;
        ...
        private void BangChamCongThangDefault()
        {
            try
            {
        ...
        private void BangChamCongThangMT()
        {
            frmViewReport frm = new frmViewReport();
            string sTieuDe = "DANH SÁCH NHÂN VIÊN TĂNG CA";
            frm.rpt = new Report.rptBangChamCongTongHopThang_MT(Convert.ToDateTime(NgayIn.EditValue));
            try
            {
                ...
                cmd.Parameters.Add("@UName", SqlDbType.NVarChar, 50).Value = Commons.Modules.UserName;
                cmd.Parameters.Add("@NNgu", SqlDbType.Int).Value = Commons.Modules.TypeLanguage;
                cmd.Parameters.Add("@NGAY", SqlDbType.Date).Value = Convert.ToDateTime(NgayIn.EditValue);
        ...
        private void BangChamCongTangCaThangDefault()
        {
            try
            {
                System.Data.SqlClient.SqlConnection conn;
