                    ...
                    case "ghi":
                        {
                            ...
                            cmd.Parameters.Add("@NGUOI_YC", SqlDbType.NVarChar).Value = string.IsNullOrEmpty(txtNGUOI_YEU_CAU.EditValue.ToString()) ? null : txtNGUOI_YEU_CAU.EditValue;
                            ...
                            cmd.Parameters.Add("@NGUOI_LIEN_HE", SqlDbType.NVarChar).Value = string.IsNullOrEmpty(txtNGUOI_YEU_CAU.EditValue.ToString()) ? null : txtNGUOI_YEU_CAU.EditValue;
                            cmd.Parameters.Add("@HOT_LINE", SqlDbType.NVarChar).Value = string.IsNullOrEmpty(txtHOT_LINE.EditValue.ToString()) ? null : txtHOT_LINE.EditValue;
                            cmd.Parameters.Add("@EMAIL", SqlDbType.NVarChar).Value = string.IsNullOrEmpty(txtEMAIL.EditValue.ToString()) ? null : txtEMAIL.EditValue;
                            cmd.Parameters.Add("@PHONE", SqlDbType.NVarChar).Value = string.IsNullOrEmpty(txtPHONE.EditValue.ToString()) ? null : txtPHONE.EditValue;
                            ...
                            cmd.Parameters.Add("@QUYEN_LOI", SqlDbType.NText).Value = string.IsNullOrEmpty(txtQUYEN_LOI.EditValue.ToString()) ? null : txtQUYEN_LOI.EditValue;
                            cmd.Parameters.Add("@THONG_TIN_KHAC", SqlDbType.NText).Value = string.IsNullOrEmpty(txtTHONG_TIN_KHAC.EditValue.ToString()) ? null : txtTHONG_TIN_KHAC.EditValue;
                            cmd.Parameters.Add("@MUC_LUONG", SqlDbType.NVarChar).Value = string.IsNullOrEmpty(txtMUC_LUONG.EditValue.ToString()) ? null : txtMUC_LUONG.EditValue;
                            cmd.Parameters.Add("@GHI_CHU", SqlDbType.NVarChar).Value = string.IsNullOrEmpty(txtGHI_CHU.EditValue.ToString()) ? null : txtGHI_CHU.EditValue;
