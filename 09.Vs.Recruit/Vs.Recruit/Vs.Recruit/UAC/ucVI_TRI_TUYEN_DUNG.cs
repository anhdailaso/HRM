        ...
        private void DeleteData()
        {
            ...
            try
            {
                if (xTraTabControl.SelectedTabPage == tabVI_TRI_TUYEN_DUNG)
                {
                    ...
                    //    return;
                    //}
                    SqlHelper.ExecuteNonQuery(Commons.IConnections.CNStr, CommandType.Text, "DELETE	dbo.VI_TRI_TUYEN_DUNG WHERE ID_VT = " + grvViTriTD.GetFocusedRowCellValue("ID_VT") + "");
